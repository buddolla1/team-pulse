...
// Send invoice via email (must come before /:id to avoid route conflict)
router.post('/:id/send-email', requirePermission('invoices.view'), invoiceController.sendInvoiceEmail);
