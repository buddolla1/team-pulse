...
('generaluser', 'General User', 'Access limited to incident, leave, and release data', TRUE);
...
-- Insert Permissions for Incident Tracker Module
INSERT INTO permissions (module, action, name, description) VALUES
...
-- Insert Permissions for Leave Tracker Module
INSERT INTO permissions (module, action, name, description) VALUES
...
('leave_tracker', 'update', 'leave_tracker.update', 'Update leave requests'),
('leave_tracker', 'revoke', 'leave_tracker.revoke', 'Revoke leave requests'),
('leave_tracker', 'export', 'leave_tracker.export', 'Export leave tracker reports');

-- Insert Permissions for Release Management Module
INSERT INTO permissions (module, action, name, description) VALUES
...
WHERE module IN ('employees', 'dashboard', 'audit_logs')
   OR module IN ('incident_tracker', 'leave_tracker', 'release_management')
...
INSERT INTO role_permissions (role_id, permission_id)
SELECT
  (SELECT id FROM roles WHERE name = 'generaluser'),
  id
FROM permissions
WHERE module IN ('incident_tracker', 'release_management')
   OR (module = 'leave_tracker' AND action IN ('view', 'create'));
