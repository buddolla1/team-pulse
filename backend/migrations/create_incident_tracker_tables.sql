...
-- Incident Tracker tables merged into the BSL schema.
-- User ownership is handled through the existing admin_users table.
...
CREATE TABLE IF NOT EXISTS incident_tracker_comments (
  ...
  INDEX idx_it_comments_incident (incident_id),
  INDEX idx_it_comments_user (user_id),
  INDEX idx_it_comments_created_by (created_by),
  INDEX idx_it_comments_updated_by (updated_by)
);
...
CREATE TABLE IF NOT EXISTS incident_tracker_attachments (
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  INDEX idx_it_attachments_incident (incident_id),
  INDEX idx_it_attachments_uploaded_by (uploaded_by),
  INDEX idx_it_attachments_created_by (created_by),
  INDEX idx_it_attachments_updated_by (updated_by)
);
...
CREATE TABLE IF NOT EXISTS incident_tracker_notifications (
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  INDEX idx_it_notifications_user (user_id),
  INDEX idx_it_notifications_incident (incident_id),
  INDEX idx_it_notifications_created_by (created_by),
  INDEX idx_it_notifications_updated_by (updated_by)
);
...
CREATE TABLE IF NOT EXISTS incident_tracker_activity_logs (
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  INDEX idx_it_activity_incident (incident_id),
  INDEX idx_it_activity_user (user_id),
  INDEX idx_it_activity_created_by (created_by),
  INDEX idx_it_activity_updated_by (updated_by)
);
