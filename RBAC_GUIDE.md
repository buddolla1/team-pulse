...
mysql -u root -p employee_management < backend/migrations/roles_permissions_schema.sql
```
...
The RBAC schema is defined in `backend/migrations/roles_permissions_schema.sql`:
