...
```bash
mysql -u root -p employee_management < backend/migrations/admin_schema.sql
```
...
### Original SQL Queries Used

The admin setup is based on the original migration files in `backend/migrations/`:
...
### CORS errors
- Backend should be running on port 5010
