...
import { getAllEmployees, deleteEmployee, resetEmployeePassword, getAllProjects, getAllTeams, getLookupsByCategory, getEmployeeRoles } from '../../services/api';
  ...
  return (
    <div className="card">
      ...
      >
        ...
        <Column field="sso" header="SSO" sortable frozen style={{ minWidth: '120px' }} />
